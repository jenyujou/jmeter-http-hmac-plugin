...
import com.sbux.jmeter.assertions.ResponseTableDataAssertion;

/**
 * GUI interface for a {@link ResponseTableDataAssertion}.
 * 
 * @author: jjou
 *
 */
public class ResponseTableDataAssertionGui extends AbstractAssertionGui {
    private static final long serialVersionUID = 240L;

    /** The name of the table columns in the list of data. */
    private static final String COL_RESPONSE_TABLE_FIELDS = "assertion_response_tabledata"; //$NON-NLS-1$
    private static final String COL_JMETER_VARIABLES = "assertion_jmeter_variables"; //$NON-NLS-1$
     ...
     */
    public ResponseTableDataAssertionGui() {
        init();
    }

    @Override
    public String getStaticLabel() {
        return "Response Table Data Assertions";
    }
    ...
    public TestElement createTestElement() {
    	ResponseTableDataAssertion el = new ResponseTableDataAssertion();
    ...
    public void modifyTestElement(TestElement el) {
        ...
        ResponseTableDataAssertion ra = (ResponseTableDataAssertion) el;
    ...
    public void configure(TestElement el) {
        super.configure(el);
        ResponseTableDataAssertion model = (ResponseTableDataAssertion) el;
    ...
    private JPanel createStringPanel() {
        tableModel = new PowerTableModel(new String[] { COL_RESPONSE_TABLE_FIELDS, COL_JMETER_VARIABLES, COL_REQUIRED_FIELD }, new Class[] { String.class, String.class, String.class });
        ...
        panel.setBorder(BorderFactory.createTitledBorder("Assertion Table Data Comparison")); //$NON-NLS-1$
