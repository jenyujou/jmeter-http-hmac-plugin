...
import com.sbux.jmeter.assertions.ResponseDataAssertion;

/**
 * GUI interface for a {@link ResponseDataAssertion}.
 * 
 * @author: jjou
 *
 */
public class ResponseDataAssertionGui extends AbstractAssertionGui {
    private static final long serialVersionUID = 240L;

    /** The name of the table columns in the list of data. */
    private static final String COL_RESPONSE_FIELDS = "assertion_response_nodes"; //$NON-NLS-1$
     ...
     */
    public ResponseDataAssertionGui() {
        init();
    }
    ...
    public TestElement createTestElement() {
        ResponseDataAssertion el = new ResponseDataAssertion();
    ...
    public void modifyTestElement(TestElement el) {
    	...
    	ResponseDataAssertion ra = (ResponseDataAssertion) el;
    ...
    public void configure(TestElement el) {
        super.configure(el);
        ResponseDataAssertion model = (ResponseDataAssertion) el;
    ...
    private JPanel createStringPanel() {
        tableModel = new PowerTableModel(new String[] { COL_RESPONSE_FIELDS, COL_JMETER_VARIABLES, COL_REQUIRED_FIELD }, new Class[] { String.class, String.class, String.class });
