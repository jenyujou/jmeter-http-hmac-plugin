...
import com.sbux.jmeter.assertions.ResponseJsonXmlDataAssertion;

/**
 * GUI interface for a {@link ResponseJsonXmlDataAssertionGui}.
 * 
 * @author: jjou
 *
 */
public class ResponseJsonXmlDataAssertionGui extends AbstractAssertionGui {
    ...
    private static final String COL_TARGET_JSON_FIELDS = "assertion_xml_variables"; //$NON-NLS-1$
     ...
     */
    public ResponseJsonXmlDataAssertionGui() {
        init();
    }

    @Override
    public String getStaticLabel() {
        return "Response JSON and XML Data Assertion";
    }
    ...
    public TestElement createTestElement() {
    	ResponseJsonXmlDataAssertion el = new ResponseJsonXmlDataAssertion();
    ...
    public void modifyTestElement(TestElement el) {
        ...
        ResponseJsonXmlDataAssertion ra = (ResponseJsonXmlDataAssertion) el;
        ...
        ra.addxmlfileStrings(xmlfileField.getText());
    }
    ...
    public void configure(TestElement el) {
        super.configure(el);
        ResponseJsonXmlDataAssertion model = (ResponseJsonXmlDataAssertion) el;
        showScopeSettings(model, true);

        xmlfileField.setText("");
        JMeterProperty pxmlfile = model.getxmlfileStrings();
        xmlfileField.setText(pxmlfile.getStringValue());
        xmlfileField.firePropertyChange(getName(), true, true);
    ...
    private JPanel createStringPanel() {
    	xmlfileField = new JTextField(90);
    	xmlfileField.setToolTipText("Jmeter variable/parameter name contains XML data to be compared.");
        ...
        panel.setBorder(BorderFactory.createTitledBorder("Assertion JSON and XML Data Comparison")); //$NON-NLS-1$
