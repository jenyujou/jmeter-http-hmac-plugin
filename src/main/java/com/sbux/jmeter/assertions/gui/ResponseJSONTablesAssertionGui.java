...
import com.sbux.jmeter.assertions.ResponseJSONTablesAssertion;

/**
 * GUI interface for a {@link ResponseJSONTablesAssertionGui}.
 * 
 * @author: jjou
 *
 */
public class ResponseJSONTablesAssertionGui extends AbstractAssertionGui {
    private static final long serialVersionUID = 240L;

    /** The name of the table columns in the list of data. */
    private static final String COL_ACTUAL_DATA = "table_actual_data"; //$NON-NLS-1$
    private static final String COL_EXPECTED_DATA = "table_expected_data"; //$NON-NLS-1$
    ...
    /** Text field for skipped JSON fields. */
    private JTextField skippedFields;
     ...
     */
    public ResponseJSONTablesAssertionGui() {
        init();
    }

    @Override
    public String getStaticLabel() {
        return "Response JSON Tables Assertion";
    }
    ...
    public TestElement createTestElement() {
    	ResponseJSONTablesAssertion el = new ResponseJSONTablesAssertion();
    ...
    public void modifyTestElement(TestElement el) {
        ...
        ResponseJSONTablesAssertion ra = (ResponseJSONTablesAssertion) el;
        ...
        ra.addSkippedStrings(skippedFields.getText());
    }
    ...
    public void configure(TestElement el) {
        super.configure(el);
        ResponseJSONTablesAssertion model = (ResponseJSONTablesAssertion) el;

        skippedFields.setText("");
        JMeterProperty pskippedFields = model.getSkippedStrings();
        skippedFields.setText(pskippedFields.getStringValue());
        skippedFields.firePropertyChange(getName(), true, true);
    ...
    private JPanel createStringPanel() {
    	skippedFields = new JTextField(90);
    	skippedFields.setToolTipText("List of skipped JSON fields devided by semicolon. ect., abc,cba");
    	
    	tableModel = new PowerTableModel(new String[] { COL_ACTUAL_DATA, COL_EXPECTED_DATA, COL_REQUIRED_FIELD }, new Class[] { String.class, String.class, String.class });
        ...
        panel.add(skippedFields, BorderLayout.NORTH);
    ...
    private class AddDataListener implements ActionListener {
        @Override
        public void actionPerformed(ActionEvent e) {
        	skippedFields.getDocument().addDocumentListener(null);
            GuiUtils.stopTableEditing(stringTable);
